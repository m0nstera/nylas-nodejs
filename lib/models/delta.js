(function() {
  ...
  module.exports = Delta = (function() {
    ...
    Delta.prototype.startStream = function(cursor, excludeTypes, params) {
      if (excludeTypes == null) {
        excludeTypes = [];
      }
      return this._startStream(request, cursor, excludeTypes, params);
    };

    Delta.prototype._startStream = function(createRequest, cursor, excludeTypes, params) {
      var stream;
      if (excludeTypes == null) {
        excludeTypes = [];
      }
      stream = new DeltaStream(createRequest, this.connection, cursor, excludeTypes, params);
      stream.open();
      return stream;
    };
  ...
  DeltaStream = (function(superClass) {
    ...
    function DeltaStream(createRequest1, connection, cursor1, excludeTypes1, params) {
    ...
    DeltaStream.prototype.open = function() {
      ...
      queryObj = Object.assign(queryObj, this.params)
